...
exports.handler = async function (event, context) {
  ...
  try {
    ...
    if (!isValidPersonalInformation.valid) {
      
      console.log(`verifyPersonalInformation: => \n${JSON.stringify(isValidPersonalInformation, null, 2)}`);
      
      eventPayload.detailType = "Claim.Rejected";
      eventPayload.detail = {
        ...eventPayload.detail,
        message: "Personal information (Driver's License) does not match" + JSON.stringify(isValidPersonalInformation, null, 2),
      };
